 ...
 * ### Usage
  ...
  ```
 * <example-url>../screenshots/components/v2/form-title.png</example-url>
 */
@Component({
  selector: 'moh-form-title',
  templateUrl: './form-title.v2.component.html',
  styleUrls: ['./form-title.v2.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FormTitleV2Component extends FormTitleBase {
