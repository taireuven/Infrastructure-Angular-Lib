...
@Component({
  ...
  templateUrl: './radiobutton-table.component.html',
  styleUrls: ['./radiobutton-table.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => RadiobuttonTableComponent), multi: true
    },
    { provide: NG_VALIDATORS, multi: true, useExisting: forwardRef(() => RadiobuttonTableComponent) },
  ]
})
export class RadiobuttonTableComponent extends RadiobuttonTableBase  {
