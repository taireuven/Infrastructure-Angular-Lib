 ...
 * ### Usage
  ...
  ```
 * <example-url>../screenshots/components/v2/submit-button.png</example-url>
*/
@Component({
  selector: 'moh-submit-button',
  templateUrl: './submit-button.v2.component.html',
  styleUrls: ['./submit-button.v2.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class SubmitButtonV2Component extends SubmitButtonBase {
